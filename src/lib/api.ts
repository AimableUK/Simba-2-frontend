...
export const productApi = {
  ...
  adminList: (params?: Record<string, any>) => api.get('/admin/products', { params }),
...
export const categoryApi = {
  ...
  adminList: (params?: Record<string, any>) => api.get('/admin/categories', { params }),
...
export const orderApi = {
  ...
  adminList: (params?: Record<string, any>) => api.get('/admin/orders', { params }),
...
export const blogApi = {
  ...
  addComment: (id: string, content: string) => api.post(`/blogs/${id}/comments`, { content }),
  deleteComment: (id: string, commentId: string) => api.delete(`/blogs/${id}/comments/${commentId}`),
  adminList: (params?: Record<string, any>) => api.get('/admin/blogs', { params }),
...
export const contactApi = {
  ...
  adminList: (params?: Record<string, any>) => api.get('/admin/contacts', { params }),
...
export const userApi = {
  ...
  adminList: (params?: Record<string, any>) => api.get('/admin/users', { params }),
