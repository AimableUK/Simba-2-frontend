          ...
          <div className="space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2 border-t border-border">
              ...
              <div className="flex gap-2">
                ...
                >
                  <svg
                    className="h-4 w-4 text-muted-foreground group-hover:text-[#25D366]"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                ...
                >
                  <svg
                    className="h-4 w-4 text-muted-foreground group-hover:text-[#1877F2]"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                ...
                >
                  <svg
                    className="h-4 w-4 text-muted-foreground group-hover:text-[#1DA1F2]"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
                ...
                {typeof navigator !== "undefined" &&
                  navigator.share !== undefined && (
                    <button
                      onClick={async () => {
                        try {
                          await navigator.share({
                            title: product.name,
                            text: `Check out ${product.name} at Simba Supermarket!`,
                      ...
                      className="p-2.5 rounded-xl border border-border hover:border-primary hover:bg-primary/10 transition-colors group"
                      title="Share"
                    >
